...
mongosh --host "shard-2-a:$MONGODB_PORT" --eval "rs.initiate({_id: 'shard-2-rs', members: [{_id: 0, host: 'shard-2-a:$MONGODB_PORT'}, {_id: 1, host: 'shard-2-b:$MONGODB_PORT'}, {_id: 2, host: 'shard-2-c:$MONGODB_PORT'}]})"
